...
mongoose.connect('mongodb+srv://bottingup:mhFSpF8aytE@cluster0.j5un5.mongodb.net/?retryWrites=true&w=majority');
...
var id = "629e121171ca0aff3d5870a4";

BlogPost.findByIdAndUpdate(id,{title:'Updated Titlm',
},(error, blogpost) =>{
    console.log(error, blogpost)
})